  ...
  return (
    <>
      {isFetching ? (
        ...
        <div
          className={`scroll-container  relative w-[100%] h-[100%] rounded-xl  overflow-y-auto text-white bg-zinc-900  pb-35`}
            ...
            >
              ...
              >
                <img
                  ...
                  alt="artist-img"
                  className={`max-w-full max-h-full min-w-full min-h-full object-cover  cursor-pointer rounded-full`}
                />
              </div>
              ...
              >
                ...
                <div className="font-sans flex  gap-1  max-w-full truncate">
                  ...
                  <span className="opacity-80">
                    {(artist.followers.users.length + artist.followers.artists.length)  == 1
                      ? `• ${(artist.followers.users.length + artist.followers.artists.length)} listener`
                      : `• ${(artist.followers.users.length + artist.followers.artists.length)} listeners`}
                  </span>
                </div>
              </div>
            </div>
